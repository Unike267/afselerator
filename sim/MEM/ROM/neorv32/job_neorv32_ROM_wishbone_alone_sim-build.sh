...
cp sw/example/rom-partial/neorv32_application_image.vhd ../../partial_neorv32_application_image.vhd
cp sw/example/rom-all/neorv32_application_image.vhd ../../all_neorv32_application_image.vhd
