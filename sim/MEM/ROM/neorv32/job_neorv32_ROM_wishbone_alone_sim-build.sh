...
cp sw/example/rom-partial/neorv32_application_image.vhd ../../rom_partial_neorv32_application_image.vhd
cp sw/example/rom-all/neorv32_application_image.vhd ../../rom_all_neorv32_application_image.vhd
